import"./supabaseClient-WTCtVqgB.js";/* empty css              */import{i as E}from"./layout-BuEx1KZr.js";import{a as c}from"./utils-CZwHw4kl.js";import{z as I}from"./dataService-P9YE594z.js";import{b as A,D as S,g as B}from"./theme-BmY-8nnP.js";import"https://esm.sh/@supabase/supabase-js@2";const R=(e="")=>`${e}`.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),L=()=>A(B())||S.company_name,D=()=>(L()||"Company").toLowerCase().replace(/[^a-z0-9]+/g,"_").replace(/^_+|_+$/g,"").substring(0,60)||"company";window.XLSX||(window.XLSX={utils:{json_to_sheet:e=>e,book_new:()=>({Sheets:{},SheetNames:[]}),book_append_sheet:(e,t,n)=>{e.Sheets[n]=t,e.SheetNames.push(n)}},writeFile:(e,t)=>{const n=e.SheetNames[0],a=e.Sheets[n];if(!a||a.length===0)return;const r=Object.keys(a[0]),i=[r.join(","),...a.map(o=>r.map(d=>{const h=o[d]===null||o[d]===void 0?"":o[d];return typeof h=="string"?`"${h.replace(/"/g,'""')}"`:h}).join(","))].join(`
